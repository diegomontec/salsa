...
export default function SecaoQuatro() {
  return (
    <div>
      <div className="w-full relative flex flex-col sm:flex-row items-center justify-between p-16 text-left text-[1.75rem] text-verde font-work-sans gap-8">
        {/* Seção Texto */}
        ...
        <div className="formulario flex w-full items-center justify-center sm:w-1/2">
          <Formulario /> {/* Usando o componente Formulario */}
        </div>
      </div>
    </div>
  );
