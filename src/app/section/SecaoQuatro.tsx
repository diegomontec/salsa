...
export default function SecaoQuatro() {
  return (
    <div>
      <div className="w-full relative flex flex-col sm:flex-row items-center justify-between p-16 text-center md:text-left text-2xl text-verde font-work-sans gap-8">
        {/* Seção Texto */}
