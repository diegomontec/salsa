...
export default function Hero() {
  return (
    <div className="w-full relative h-[100vh] flex justify-center items-center bg-hero bg-cover bg-no-repeat bg-center font-work-sans">
      <div className="flex flex-col items-center justify-center rounded-lg px-4 md:px-12 lg:ml-80">
        <div className="relative bg-white rounded-lg p-6 md:px-12 md:pb-12 gap-6 md:gap-8 text-verde flex flex-col items-center">
          <Image
            width={284}
            height={284}
            alt="Logo Salsa"
            src="/HeroLogoSalsa.png"
            className="w-[200px] h-[200px] md:w-[284px] md:h-[284px]"
          />
          <div className="text-center">
            <b className="text-amarelo block text-lg md:text-xl lg:text-2xl">
          ...
          <div className="flex justify-center items-center gap-4">
            <Image
              ...
              alt="Logo Markup"
              src="/LogoMarkup.png"
              className="w-[4rem] h-[2rem] md:w-[5.75rem] md:h-[3.313rem]"
            />
            <Image
              width={145}
              height={37}
              alt="Logo Record"
              src="/LogoRecord.png"
              className="w-[6rem] h-[1.5rem] md:w-[9.063rem] md:h-[2.313rem]"
            />
          </div>
        </div>
        <div className="mt-4 text-white text-lg md:text-2xl lg:text-3xl">
          <b>Beira-Mar </b>
          <span>de</span>
          <b> Guaxuma</b>
        </div>
